...
parser_update.add_argument('--id',
                           help="Expense id to update", type=int, required=True)

parser_update.add_argument('--amount', '--a',
                           help="Add expense value", type=float, required=False)

parser_update.add_argument('--description', '--d',
                           help="Describe the expense", type=str, required=False)
...
parser_delete.add_argument('--id',
                           help="Expense id to delete", type=int, required=True)
